...
int main() {
    try {
        ...
        benchmark.addProgram("p-primes.exe", "C:/users/phine/desktop/primes_ben/dist/p-primes-5c.exe");
        benchmark.addProgram("p-primes.exe", "C:/users/phine/desktop/primes_ben/dist/p-primes-50k.exe");
        benchmark.addProgram("p-primes.exe", "C:/users/phine/desktop/primes_ben/dist/p-primes-500k.exe");
