...
int main() {
    try {
        // Using 30 second timeout (30000ms)
        ExeBenchmarker benchmark(10, 10, true, 125000);

        // Add your executables to benchmark
        benchmark.addProgram("p-primes-5c.exe", "C:/users/phine/desktop/primes_ben/dist/p-primes-5c.exe");
        benchmark.addProgram("p-primes-50k.exe", "C:/users/phine/desktop/primes_ben/dist/p-primes-50k.exe");
        benchmark.addProgram("p-primes-500k.exe", "C:/users/phine/desktop/primes_ben/dist/p-primes-500k.exe");
